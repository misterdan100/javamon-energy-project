...
export default function page() {
  const energias = data.energias as Energia[];


  return (
    <>
      <Navbar>Departamentos</Navbar>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <div>
              <div className="flex items-center gap-x-3">
                <h2 className="text-lg font-medium text-gray-800">Instalaciones</h2>

                <span className="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full ">
                   {energias.length} instancias
                </span>
              </div>

              <p className="mt-1 text-sm text-gray-500 ">
              Muestra una lista de todas las instalaciones agrupadas por departamento.
              </p>
            </div>

            <div className="flex items-center mt-4 gap-x-3 opacity-50">
