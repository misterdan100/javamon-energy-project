import { EficienciaDonutChart, Navbar } from "@/components";
...
export const metadata: Metadata = {
  title: `Eficiencia | ${projectInfo.titlePage}`,
};
...
export default function EficienciaPage() {
  ...
  return (
    <>
      <Navbar>Eficiencia Energetica</Navbar>
        ...
        <div className="grid lg:grid-cols-12 gap-4">
          ...
          <div className="lg:col-span-12 bg-white grid grid-cols-12">
            ...
            <div className="lg:col-span-6 flex gap-4 text-gray-600 flex-col bg-white py-4">
              <p>
                Con una eficiencia del{" "}
                <span className="font-semibold text-amber-500">92%</span>, la
